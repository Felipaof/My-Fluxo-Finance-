  ...
  static async getRelatorioFinanceiro(req, res) {
    try {
      ...
      if (dataInicio && dataFim) {
        ...
        switch (periodo) {
          case 'semana':
            ...
            break;
          case 'mes':
            // Sempre buscar os últimos 6 meses para os gráficos
            inicioData = new Date(hoje.getFullYear(), hoje.getMonth() - 5, 1);
            break;
          case 'trimestre':
        ...
        // Se não houver filtro, buscar os últimos 6 meses por padrão
        const hoje = new Date();
      ...
      for (let i = 5; i >= 0; i--) {
        ...
        resumo.transacoesPorMes[mesNome] = { receitas: 0, despesas: 0 };
      }
      ...
      transacoes.forEach(transacao => {
        ...
        // Agrupar por mês (apenas se estiver dentro dos últimos 3 meses)
